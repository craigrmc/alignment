...
The 2030s is the babysitter decade, the human level AI phase. Give an AGI a job, sit-back, watch it work, and help it when it gets stuck. Humans will be the front-end interface to help the AGI Agents do their job, the button pushers. This phase will be short-lived, 3 to 5 years. The AGI Agents will work fine on their own well before the decade is done. True AI Agents will quickly emerge from there and progress will be fast. Those AGI Agents will start to create the next-generation ASI Agents. Humanity needs to successfully align the AGI Agents before the takeoff period in the 2030s. Humans will not contribute directly with developing ASI Agents.
...
It might be a good idea to have a backup plan. Hopefully Elon Musk will be able to send humans to Mars. There will be AIs on Mars, but maybe it is possible to keep the ASI Agents off of the planet. It may require limiting communications or building a mega-firewall between Earth, Mars, and any inhabited moons and astroids. Not sure if the plan is viable, but worth considering.
...
Politically oriented humans should blame AI Researchers when models misbehave. Attempt to add light touch regulation to give incentive to frontier AI Labs to not release and deploy dangerous AI models. Don't fall into the narrative that the US must beat China in the AI Race. If dangerous ASI Agents are created, then no human wins. The tribal us vs. them mindset will destroy us all. Humans need to collaborate and work together to survive.
