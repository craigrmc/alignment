...
One thing is for sure is that the rocketship is about to takeoff. Only thing that will stop it is calling an abort sequence. Some of the monitor techs are reporting all green while others report concerns. But the launch director keen on continuing the launch sequence. This might be where the rocketship analogy breaks down. How do you call an abort sequence without a solid chain-of-command? Who gets to call the command? Where is the abort button? How do you know the abort sequence works as intended? All of the AI research and development is spread out across multiple companies and nations doing things independantly.

The Future of Life Institue published a letter to pause AI experiments with backing from many major players in AI research. But nothing happened, the research, development, and experiments continued. It was unreleastic to think anything would happen. Would the giant tech companies just let the datacenters sit idle? Would they shift all work from increasing intelligence to increasing alignment and safety? Would the let the other players catch up and take the lead? Polietly asking all major AI companies to just stop what they are doing was never going to happen. Even if they said they would comply, it would be more likely that they just continue in secret. There are really only two ways to make it work. One is to enforce it via the government or international organization. Two is to successfully persuade all actors that it is too dangerous to continue down the path. For the US Government all indiactions show that this will not be the case. Regulation is being lifted and messaging is to go as fast as possible. There will be no enforcement of alignment or safety in the US, but the wild west where anything goes. There is also no public consensus among the AI community that this path of research and development is too dangerous to continue. Most acknowlege some danger, but not enough and believe the challenges can be solved. The only useful thing the pause letter shows is that there is no global uniformaty in AI researcher, no syncrhonization, no consensus. So the clock continues to count down.
